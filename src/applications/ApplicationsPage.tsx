...
const TOURISM_MATERIAL_URL = `${assetBase}assets/tourism-masonry.png`;
const CAREER_CARD_COVER = `${assetBase}assets/application-covers/career-card.jpg`;
const HISTORY_TODAY_COVER = `${assetBase}assets/application-covers/history-today.jpg`;
